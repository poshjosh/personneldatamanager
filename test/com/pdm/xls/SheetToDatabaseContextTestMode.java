...
public class SheetToDatabaseContextTestMode extends SheetProcessorContextImpl {
    ...
    public SheetToDatabaseMetaDataBuilder getSheetToDatabaseMetaDataBuilder() {
        return new SheetToDatabaseMetaDataBuilderFromUserInputsImpl(this.getApp()){
            @Override
            public int[] promptSelectColumns(App app, Sheet sheet, Class entityType, String message, int[] outputIfNone) {
                return outputIfNone;
            }
        };
    }
    ...
    public SelectFileThenWorksheetPrompt getSelectFileThenWorksheetPrompt() {
        return new SelectFileThenWorksheetPromptImpl(this.getApp()){
            @Override
            ...
            @Override
            public File promptSelectExcelFile() 
                    throws ParameterException, TaskExecutionException {
