...
System.out.println("Setting: "+component.getName()+" to: "+value+" in UI component: "+component.getClass().getSimpleName());            
    ...
    private Map<String, Object> getData1(App app) {
        ...
        final Dao dao = app.getActivePersistenceUnitContext().getDao();
        od.put("commissiontype", dao.find(Commissiontype.class, (short)2));
        od.put("course", "37");
        cal.set(1990, 8, 22);
        od.put("dateofcommission", cal.getTime());
        od.put("appointment", dao.find(Appointment.class, 7));
        od.put("unit", dao.find(Unit.class, 23));
        cal.set(1966, 9, 3);
        od.put("dateofbirth", cal.getTime());
        od.put("firstname", "Bello");
        od.put("gender", dao.find(Gender.class, (short)2));
        od.put("localgovernmentarea", "LGANKA");
        od.put("middlename", "Ade");
//        pd.setOfficersdata(od);
        od.put("rank", dao.find(Rank.class, (short)4));
        cal.set(2015, 8, 19);
        od.put("seniority", cal.getTime());
        od.put("servicenumber", "2197");
        od.put("stateoforigin", dao.find(Stateoforigin.class, (short)1));
        od.put("surname", "Nwosu");
//        od.setPersonneldata(pd);
        od.put("speciality", dao.find(Speciality.class, (short)1));
        return od;
    }
    ...
    private Map<String, Object> getData(App app) {
        ...
        pp.setAppointment(dao.find(Appointment.class, 2));
        cal.set(2015, 8, 16);
        pp.setDatetakenonstrength(cal.getTime());
//        pp.setPersonneldata(personneldata);
        pp.setUnit(dao.find(Unit.class, 3));
        od.put("commissiontype", dao.find(Commissiontype.class, (short)1));
        od.put("course", "49");
        cal.set(2002, 8, 19);
        od.put("dateofcommission", cal.getTime());
        od.put("appointment", dao.find(Appointment.class, 2));
        cal.set(1978, 4, 9);
        od.put("dateofbirth", cal.getTime());
        od.put("firstname", "Chinomso");
        od.put("gender", dao.find(Gender.class, (short)1));
        od.put("localgovernmentarea", dao.find(Localgovernmentarea.class, 3));
        od.put("middlename", "Bassey");
//        pd.setOfficersdata(od);
        od.put("rank", dao.find(Rank.class, (short)6));
        cal.set(2015, 8, 19);
        od.put("seniority", cal.getTime());
...
//        od.setPersonneldata(pd);
    ...
    private Map<String, Object> getData_old(App app) {
        ...
        persposting.setAppointment(dao.find(Appointment.class, 2));
        cal.set(2015, 8, 16);
        persposting.setDatetakenonstrength(cal.getTime());
        persposting.setUnit(dao.find(Unit.class, 3));
        
        final Officersdata offrsdata = new Officersdata();
        offrsdata.setCommissiontype(dao.find(Commissiontype.class, (short)1));
        ...
        persdata.setGender(dao.find(Gender.class, (short)1));
        persdata.setLocalgovernmentarea(dao.find(Localgovernmentarea.class, (short)1));
        persdata.setMiddlename("Bassey");
        persdata.setOfficersdata(offrsdata);
        persdata.setRank(dao.find(Rank.class, (short)6));
        cal.set(2015, 8, 19);
        ...
        offrsdata.setSpeciality(dao.find(Speciality.class, (short)1));
